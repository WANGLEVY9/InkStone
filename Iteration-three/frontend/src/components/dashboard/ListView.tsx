        ...
        return (
          <div
            ...
            style={{
              ...
              background: selectedProjectIds.has(project.id) ? 'var(--vermilion-bg)' : 'transparent',
            }}
            onMouseEnter={(e) => {
              (e.currentTarget as HTMLDivElement).style.background = selectedProjectIds.has(project.id)
                ? 'var(--vermilion-bg)'
                : 'var(--paper-sunken)';
            }}
            onMouseLeave={(e) => {
          ...
          >
            {managementMode && (
              <Checkbox checked={selectedProjectIds.has(project.id)} style={{ marginRight: 12 }} />
            )}
            <div
              style={{
                width: 32,
