...
class ContentService:
    ...
    def __init__(self, db: aiosqlite.Connection, storage: FileSystemStorage | None = None):
        ...
        self._foreshadowing = ForeshadowingService(db)
    ...
    async def create_foreshadowing(
        ...
        """Create a foreshadowing entry."""
        return await self._foreshadowing.create(
            project_id,
            description,
            foreshadowed_at,
            expected_resolve_at,
    ...
    async def get_foreshadowing(self, entry_id: str, project_id: str) -> dict[str, Any] | None:
        """Retrieve a foreshadowing entry by ID."""
        return await self._foreshadowing.get(entry_id, project_id)
    ...
    async def list_foreshadowing(
        ...
        return await self._foreshadowing.list_by_project(project_id, status)
    ...
    async def update_foreshadowing(
        ...
        **kwargs: Any,
        ...
        return await self._foreshadowing.update(entry_id, project_id, **kwargs)

    async def delete_foreshadowing(self, entry_id: str, project_id: str) -> bool:
        """Delete a foreshadowing entry."""
        return await self._foreshadowing.delete(entry_id, project_id)

    async def resolve_foreshadowing(self, entry_id: str, project_id: str) -> dict[str, Any] | None:
        """Mark a foreshadowing entry as resolved."""
        return await self._foreshadowing.resolve(entry_id, project_id)

    async def get_unresolved_foreshadowing(self, project_id: str) -> list[dict[str, Any]]:
        """Get all unresolved foreshadowing entries."""
        return await self._foreshadowing.get_unresolved(project_id)

    async def search_foreshadowing(self, project_id: str, query: str) -> list[dict[str, Any]]:
        """Search foreshadowing entries by description."""
        return await self._foreshadowing.search(project_id, query)
