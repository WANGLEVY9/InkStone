...
- delegate_to_chapter: Write/edit/delete/search chapters, and detect foreshadowing
...
4. WRITE → DETECT FORESHADOWING → REVIEW → REVISE CYCLE: For each chapter:
   a. delegate_to_chapter to write the chapter (the chapter agent will
      automatically detect foreshadowing after writing)
